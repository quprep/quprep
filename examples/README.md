...
pip install quprep[braket]     # example 04
pip install quprep[qsharp]     # example 04 (Azure Quantum submission)
pip install quprep[iqm]        # example 04 (IQM hardware submission)
pip install quprep[umap]       # UMAP dimensionality reduction
pip install quprep[image]      # example 12 (image ingestion)
pip install quprep[text]       # example 12 (text embeddings)
```
